...
### `register_provider` <sup><a href="https://github.com/bhardwajRahul/fastmcp/blob/main/src/fastmcp/server/auth/registry.py#L19" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `get_registered_provider` <sup><a href="https://github.com/bhardwajRahul/fastmcp/blob/main/src/fastmcp/server/auth/registry.py#L41" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
