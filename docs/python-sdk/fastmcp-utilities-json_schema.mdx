...
### `compress_schema` <sup><a href="https://github.com/bhardwajRahul/fastmcp/blob/main/src/fastmcp/utilities/json_schema.py#L183" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
